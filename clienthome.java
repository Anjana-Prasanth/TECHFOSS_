...
public class clienthome extends JFrame {
	...
	JPanel b, c, d;
	JLabel e, f;
	JButton order, status, profile, logout, contact, help;
	Border brd;
	...
	clienthome(){
		...
		e= new JLabel();
        ImageIcon imageIcon = new ImageIcon(new ImageIcon("/Users/anjan/eclipse-workspace/PROJECT/src/LOGO.png").getImage().getScaledInstance(100, 100, 10));
        e.setIcon(imageIcon);
		...
		ImageIcon i3 = new ImageIcon(new ImageIcon("/Users/anjan/eclipse-workspace/PROJECT/src/cart.jpg").getImage().getScaledInstance(25, 25, 5));
		order.setIcon(i3);
		...
		status.setBounds(200, 300, 100, 25);
      	c.add(status);
