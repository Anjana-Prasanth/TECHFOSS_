...
public class status_client extends JFrame {
	...
	public status_client() {
		...
		show_btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String  query="select * from order_details where client_id='"+logreg.user_id+"'";
		...
		ImageIcon image21 = new ImageIcon(new ImageIcon("/Users/anjan/eclipse-workspace/PROJECT/src/status.png").getImage().getScaledInstance(lblNewLabel.getWidth(),lblNewLabel.getHeight(),Image.SCALE_DEFAULT)); 
