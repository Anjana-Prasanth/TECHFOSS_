...
public class status_admin extends JFrame {
	...
	public status_admin() {
		...
		ImageIcon image = new ImageIcon(new ImageIcon("/Users/anjan/eclipse-workspace/PROJECT/src/LOGO.png").getImage().getScaledInstance(100, 80, Image.SCALE_DEFAULT));
		...
		getbtn.addActionListener(new ActionListener() {
		  ...
		  ImageIcon image1 = new ImageIcon(new ImageIcon("/Users/anjan/eclipse-workspace/PROJECT/src/back.jpeg").getImage().getScaledInstance(lblNewLabel_1.getWidth(),lblNewLabel_1.getHeight(),Image.SCALE_DEFAULT)); 
		  lblNewLabel_1.setIcon(image1);
		  contentPane.add(lblNewLabel_1);
		  
		  JLabel lblNewLabel_2 = new JLabel("");
		  lblNewLabel_2.setBounds(0, 0, 1316, 134);
		  ImageIcon image2 = new ImageIcon(new ImageIcon("/Users/anjan/eclipse-workspace/PROJECT/src/status.jpeg").getImage().getScaledInstance(lblNewLabel_2.getWidth(),lblNewLabel_2.getHeight(),Image.SCALE_DEFAULT)); 
