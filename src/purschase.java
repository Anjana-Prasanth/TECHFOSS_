...
public class purschase extends JFrame {
	...
	public purschase() {
		...
		comboBoxname.setBounds(64, 361, 186, 35);
		...
		ImageIcon image12 = new ImageIcon(new ImageIcon("/Users/anjan/eclipse-workspace/PROJECT/src/back.jpeg").getImage().getScaledInstance(lblNewLabel_2.getWidth(),lblNewLabel_2.getHeight(),Image.SCALE_DEFAULT)); 
