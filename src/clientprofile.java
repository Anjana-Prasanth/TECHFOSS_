...
public class clientprofile extends JFrame{
    ...
    clientprofile(){    	
        ...
        try {
	    	 ...
	    	 String query="select fname,lname,email_id,phn from client where client_id='"+logreg.user_id+"'";
	    	 PreparedStatement stmt=conn.prepareStatement(query);
	    	 ResultSet rs=stmt.executeQuery();
	    	 while(rs.next())
	    	 {
	    	 d0.setText(logreg.user_id);
        ...
        ImageIcon i = new ImageIcon(new ImageIcon("/Users/anjan/eclipse-workspace/PROJECT/src/home.jpeg").getImage().getScaledInstance(25, 25, 5));
		home.setIcon(i);
